...
function comboCompleteV160(id,s){if(id==='combo-rice-noodles-two')return !!(s.base&&s.item1&&s.item2);if(id==='combo-single-item')return !!s.base;if(id==='combo-single-hot-item')return !!s.item;return false}
function comboRequiredCountV160(id){return id==='combo-rice-noodles-two'?3:1}
function comboCompleteCountV160(id,s){return id==='combo-rice-noodles-two'?[s.base,s.item1,s.item2].filter(Boolean).length:id==='combo-single-item'?(s.base?1:0):(s.item?1:0)}
function hotReadyOptionPriceV160(kind,id){return Number(hotReadyByIdV160(kind,id)?.comboUpcharge||0)}
function comboPriceV160(item,s){let n=Number(item?.price||0);if(s.base)n+=hotReadyOptionPriceV160('base',s.base);if(s.item1)n+=hotReadyOptionPriceV160('hot',s.item1);if(s.item2)n+=hotReadyOptionPriceV160('hot',s.item2);if(s.item)n+=hotReadyOptionPriceV160('hot',s.item);return Math.round(n*100)/100}
...
function renderHotReadyComboV160(){
  ...
  if(st.productId==='combo-rice-noodles-two'){
    blocks.push(`<section class="hot-ready-step-v160" data-hot-ready-step="base"><div class="hot-ready-step-title"><span>STEP 1 OF 3</span><h3>1. Choose Your Base</h3><small>Required • Select 1</small></div><div class="hot-ready-options-v160">${optionRowsV160('base','hr-base',s.base)}</div></section>`);
    blocks.push(`<section class="hot-ready-step-v160" data-hot-ready-step="item1"><div class="hot-ready-step-title"><span>STEP 2 OF 3</span><h3>2. Choose Item #1</h3><small>Required • Select 1</small></div><div class="hot-ready-options-v160">${optionRowsV160('hot','hr-item1',s.item1)}</div></section>`);
    blocks.push(`<section class="hot-ready-step-v160" data-hot-ready-step="item2"><div class="hot-ready-step-title"><span>STEP 3 OF 3</span><h3>3. Choose Item #2</h3><small>Required • Select 1 • You may choose the same item twice</small></div><div class="hot-ready-options-v160">${optionRowsV160('hot','hr-item2',s.item2)}</div></section>`);
  ...
  const summary=st.productId==='combo-rice-noodles-two'?`${hotReadySummaryLineV160('Base','base',s.base,'base')}${hotReadySummaryLineV160('Item #1','hot',s.item1,'item1')}${hotReadySummaryLineV160('Item #2','hot',s.item2,'item2')}`:st.productId==='combo-single-item'?hotReadySummaryLineV160('Base','base',s.base,'base'):hotReadySummaryLineV160('Hot Item','hot',s.item,'item');
...
function comboValidationMessageV160(row){
  ...
  if(row.id==='combo-rice-noodles-two'){if(!s.base)return 'Please choose 1 rice or noodle option for C1.';if(bad(base(s.base)))return `${base(s.base)?.name||'The selected base'} is no longer available. Please update C1.`;if(!s.item1)return 'Please choose Hot Item #1 for C1.';if(bad(hot(s.item1)))return `${hot(s.item1)?.name||'Hot Item #1'} is no longer available. Please update C1.`;if(!s.item2)return 'Please choose Hot Item #2 for C1.';if(bad(hot(s.item2)))return `${hot(s.item2)?.name||'Hot Item #2'} is no longer available. Please update C1.`}
...
function comboModifiersV160(row){const s=row.selections||{},mods=[];const base=hotReadyByIdV160('base',s.base),i1=hotReadyByIdV160('hot',s.item1),i2=hotReadyByIdV160('hot',s.item2),it=hotReadyByIdV160('hot',s.item);if(base)mods.push(`Base: ${base.name}`);if(i1)mods.push(`Hot Item #1: ${i1.name}`);if(i2)mods.push(`Hot Item #2: ${i2.name}`);if(it)mods.push(`Hot Item: ${it.name}`);const note=(row.modifiers||[]).find(x=>/^Item note:/i.test(x));if(note)mods.push(note);return mods}
